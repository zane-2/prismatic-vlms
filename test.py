...
if __name__=="__main__":
    with open("/simurgh/u/akhatua/long_context_benchmark/webvid_enriched_captions/webvid_train_45k_cleaned_captions.json", 'r') as fp:
        cleaned = list(json.load(fp))
    print(len(cleaned))

    # dataset_root_dir = Path("/vision/u/silsingh/prismatic-vlms")
    # annotation_json = Path("dataset_splits/webvid_train_45k_cluster_size=4_random.json")
    # image_dir = Path("webvid_cluster_size=4_random")
    # path_json = dataset_root_dir / annotation_json
    # path_frames = dataset_root_dir / image_dir
    # print(path_json, path_frames)
